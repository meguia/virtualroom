...
#json_file_input = presetdir / 'sala_minimal.json'
...
try:
    ...
    object_list = room_utils.make_speaker_array(
                                                room, 
                                                speaker_data, 
                                                stand_data_array, 
                                                speaker_height, 
    ...
    print('No sources declared on room')
    

#LUCES
# importar asset
if hasattr(room, 'lighting'):
